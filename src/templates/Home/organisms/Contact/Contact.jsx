    ...
    return(
        <section id='contact' className={ styles.contact_section }>
            ...
            <div className={ styles.contact_content_container }>
                <p className={ styles.contact_text_description }>I am interested in new job offers. If you have a question, don’t hesitate to contact me</p>
                <div className={ styles.box_contact_options }>
